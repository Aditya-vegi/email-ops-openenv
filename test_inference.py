...
# Local testing version - handle missing environment variables gracefully
try:
...
async def main():
    ...
    """
    print("🚀 Starting Email Operations Assistant...")
...
if __name__ == "__main__":
    print("🧪 Testing Email Operations Assistant locally...")
    asyncio.run(main())
